...
def main():
    ...
    countyRunList = [
        ...
        [True, 'redl', 'MN Geo', 'Red Lake'],
        [True, 'redw', 'MN Geo', 'Redwood'],
        [True, 'renv', 'MN Geo', 'Renville'],
        [True, 'rice', 'MN Geo', 'Rice'],
        [True, 'rock', 'MN Geo', 'Rock'],
        [True, 'rose', 'MN Geo', 'Roseau'],
        [False, 'scot', 'MN Geo', 'Scott'], # completed in metr
        [True, 'sher', 'MN Geo', 'Sherburne'],
        [True, 'sibl', 'MN Geo', 'Sibley'],
        [True, 'stlo', 'MN Geo', 'St. Louis'],
        [True, 'stea', 'MN Geo', 'Stearns'],
        [True, 'stee', 'MN Geo', 'Steele'],
        [True, 'stev', 'MN Geo', 'Stevens'],
        [True, 'swif', 'MN Geo', 'Swift'],
        [True, 'todd', 'MN Geo', 'Todd'],
        [True, 'trav', 'MN Geo', 'Traverse'],
        [True, 'waba', 'MN Geo', 'Wabasha'],
        [True, 'wade', 'MN Geo', 'Wadena'],
        [True, 'wase', 'MN Geo', 'Waseca'],
